...
// (2026-08-12). A LABELLED DEMO token: it is the only EIP-3009 substrate on
// Coston2 (neither FXRP nor the real USD₮0 implements transferWithAuthorization),
// so x402 settles against it. Every kit surface renders it as a demo token; it is
// never shown as USD₮0 or FXRP. Public mint is intentional (demo funding only).
