...
// flare-kit M9 reference contract — copied VERBATIM from
// sources/flare-foundation/flare-hardhat-starter/contracts/x402/X402Facilitator.sol
// (2026-08-12). Deployed FEE-FREE (feeBps = 0). NOTE: the inherited feeBps /
// feeRecipient / setFeeBps fields are INERT — settlePayment transfers the full
// `value` and never applies a fee. They are placeholders from the example, not a
// working fee model (M9 explicitly does not build one). The kit renders no fee.
